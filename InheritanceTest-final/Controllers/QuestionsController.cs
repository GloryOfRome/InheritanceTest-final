...
namespace InheritanceTest_final.Controllers
{
    public class QuestionsController : Controller
    {
        private readonly InheritanceTest_finalContext _context;

        public QuestionsController(InheritanceTest_finalContext context)
        {
            _context = context;
        }
